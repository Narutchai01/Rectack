import LikedPost from "../ArticleSidebarComponents/LikedArticle";
import TrendingPost from "../ArticleSidebarComponents/TrendingArticle";
import CreateArticle from "../ArticleSidebarComponents/CreateArticle";
...
const ArticleSidebar = (props) => {
  const trendingPosts = [
    ...
    const handleCreateArticle = (element) => { 
      setCreateArticle(element);
    }
  
    return (
      <div className="fixed w-[25%]">
          <CreateArticle createArticle={handleCreateArticle}/>
